...
public class ClientBLL {
    ...
    /**
     * This class finds a Client with a specified id
     *
    ...
    /**
     * @return a list of all Clients from the Data Base
     */
    ...
    public void updateClient(int index, Client clientNew) {
        Client client = clientAtIndex(index);
        int id = client.getId();
        client = new Client(id, clientNew.getName(), clientNew.getAddress());
